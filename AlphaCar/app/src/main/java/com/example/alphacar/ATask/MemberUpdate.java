...
public class MemberUpdate extends AsyncTask<Void, Void, String> {
    ...
    public MemberUpdate(String customer_email, String customer_pw, String customer_name, String admin, String customer_picture) {
        ...
        Log.d(TAG, "MemberUpdate: " + customer_picture);
    }
