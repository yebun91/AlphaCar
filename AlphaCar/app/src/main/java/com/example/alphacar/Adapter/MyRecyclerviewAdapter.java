...
import static com.example.alphacar.MainActivity.selItem;
...
import com.example.alphacar.Dto.MyItem;
...
public class MyRecyclerviewAdapter extends RecyclerView.Adapter<MyRecyclerviewAdapter.ItemViewHolder>{
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(MyItem item){
            ...
            id.setText(item.getStore_name());
            name.setText(item.getInventory()+"");
            date.setText(item.getCustomer_email());
