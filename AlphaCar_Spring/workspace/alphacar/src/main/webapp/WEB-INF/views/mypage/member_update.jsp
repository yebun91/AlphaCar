...
<main class="mypage">
	...
	<input type="hidden" value="${loginInfo.social }" id="mypageSocial">
		<form action="memberSubmit.mp" enctype="multipart/form-data"
			...
			<div class="join_addr">
				<h3>지역을 선택해주세요.</h3>
				<select name="city" id="city"></select> <select name="addr"
					id="gugun"></select>
			</div>
			...
			<input type="hidden" name="customer_picture"
				value="${vo.customer_picture}" /> <input type="file"
				name="image_file" style="display: none" class="image_upload"
				accept="image/*" />
