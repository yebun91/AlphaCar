...
public class StoreRegister extends AsyncTask<Void, Void, String> {
    ...
    public StoreRegister(String customer_email, String store_name, String store_addr, String store_tel, String store_time, String store_dayoff, String introduce, int inventory, String store_price, String store_master_name, String store_registration_number, ArrayList<String> storePic) {
        this.customer_email = customer_email;
        this.store_name = store_name;
        this.store_addr = store_addr;
        this.store_tel = store_tel;
