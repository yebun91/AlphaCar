...
public class DetailAdapter extends BaseExpandableListAdapter {
    ...
    public DetailAdapter(Context context, List<String> groupList,
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.detail_group_item, null);
        }
        TextView item = view.findViewById(R.id.store_info_parent);
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.detail_child_item, null);
        }
        TextView item = view.findViewById(R.id.store_info_child);
