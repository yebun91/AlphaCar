...
public class JoinInsert extends AsyncTask<Void, Void, String> {
    ...
    public JoinInsert(String customer_email, String customer_pw, String customer_name, String admin, String customer_picture) {
        ...
        Log.d(TAG, "JoinInsert: " + customer_picture);
    }

    public JoinInsert(String customer_email, String customer_pw, String customer_name, String admin) {
        this.customer_email = customer_email;
        this.customer_pw = customer_pw;
        this.customer_name = customer_name;
        this.admin = admin;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            //이미지 전송
            if(customer_picture.isEmpty()){
                builder.addTextBody("customer_picture", customer_picture, ContentType.create("Multipart/related", "UTF-8"));
            }else{
