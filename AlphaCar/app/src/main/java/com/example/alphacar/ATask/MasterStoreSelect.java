...
public class MasterStoreSelect extends AsyncTask<Void, Void, Void> {
    ...
    public MasterStoreSelect(ArrayList<RegisterDTO> dtos) {
        this.dtos = dtos;
    }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/alphacar/android/anSelectMaster";
            // 그대로 사용  복,붙
...
// doInBackground 끝난후에 실행하는 부분
    ...
    private RegisterDTO readMessage(JsonReader reader) throws IOException {
